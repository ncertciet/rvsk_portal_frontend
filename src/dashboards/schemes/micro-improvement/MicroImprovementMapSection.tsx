...
import ImprovementsStatusTab from './tabs/ImprovementsStatusTab';
...
interface MicroImprovementMapSectionProps {
  statewiseData: StatewiseData[];
}

export default function MicroImprovementMapSection({
  statewiseData,
}: MicroImprovementMapSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Tab Content */}
      {tab === 0 && <ImplementationStatusTab statewiseData={statewiseData} />}
      {tab === 1 && <ImprovementsStatusTab statewiseData={statewiseData} />}

      {/* Last Updated */}
      <Box sx={{ mt: 2, textAlign: 'right' }}>
        <Typography variant="caption" color="text.secondary">
          Last Updated date : 22-JUL-2026
        </Typography>
      </Box>
    </Box>
  );
