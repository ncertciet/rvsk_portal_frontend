...
export default function MicroImprovementBanner() {
  return (
    <Box
      sx={{
        position: 'relative',
    ...
    >
      ...
      >
        ...
        <Box sx={{ position: 'absolute', top: 50, left: 180 }}>✏️</Box>
        ...
        <Box sx={{ position: 'absolute', top: 60, right: 320 }}>✏️</Box>
      ...
      <Box sx={{ zIndex: 1, maxWidth: '55%' }}>
        ...
        >
          Small Steps to Build Great Schools
        </Typography>
      </Box>
